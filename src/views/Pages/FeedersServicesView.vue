...
export default defineComponent({
  ...
  components: { HeroBanner, accordionComponent },
  data() {
    return {
...
<template>
  <sectio class="FeedersServices">
    <!-- Hero Section -->
    <HeroBanner
      :titleKey="$t('FeedersServices.heroTitle')"
      :title="$t('FeedersServices.heroDesc')"
      :subtitleKey="$t('FeedersServices.heroDesc')"
      height="50vh"
      :media-src="heroBg"
      :withImg="true"
    />
