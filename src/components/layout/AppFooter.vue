            ...
            sections: [
                {
                    ...
                    links: [
                        ...
                        { labelKey: 'footer.sections.about.links.stakeholders', to: '/stakeholders-relations' },
                ...
                },
                {
                    ...
                    links: [
                        { labelKey: 'footer.sections.business.links.feeders', to: '/feeders-services' },
                        { labelKey: 'footer.sections.business.links.liner', to: '/regional-liner-services' },
                        { labelKey: 'footer.sections.business.links.routes', to: '/routes-agents' },
                        { labelKey: 'footer.sections.business.links.faq', to: '/faq-glossary' },
                ...
                },
                {
                    ...
                    links: [
                        { labelKey: 'footer.sections.media.links.news', to: '/news-insights' },
                        { labelKey: 'footer.sections.media.links.downloads', to: '/downloads' },
                    ],
                },
            ] as FooterSection[],
            socialLinks: [
        ...
        <div class="footer-shell">
            <div class="footer-top">
                ...
                <div class="footer-feedback">
                    <button class="footer-feedback__cta" type="button" @click="openFeedback">
                    ...
                    <ul class="footer-social__list">
                        <li v-for="item in socialLinks" :key="item.id">
                            <a :href="item.href" target="_blank" rel="noopener" :aria-label="item.label">
                                <span :class="['icon', `icon--${item.id}`]" aria-hidden="true"></span>
                            </a>
                        </li>
                    </ul>
                </div>
...
.footer-feedback__cta {
    ...
    border-radius: 9px;
    background: linear-gradient(135deg, #7eff5d, #48e186);
    color: #05311b;
    font-weight: 600;
    font-size: 0.95rem;
    text-align: center;
...
.footer-feedback__cta:focus-visible {
    ...
    box-shadow: 0 16px 32px rgba(72, 225, 134, 0.35);
}
